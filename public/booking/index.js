...
async function loadCurrentUserData() {
  if(firebase.auth().currentUser !== null){
    ...
    const userData = result.data.data;
    document.getElementById("Vorname").value = userData.firstName === undefined || null ? "" : userData.firstName;
    document.getElementById("Nachname").value = userData.lastName === undefined || null ? "" : userData.lastName;
    document.getElementById("Email").value = userData.email === undefined || null ? "" : userData.email;
    document.getElementById("Rufnummer").value = userData.phone === undefined || null ? "" : userData.phone;
    document.getElementById("Postleitzahl").value = userData.zipCode === undefined || null ? "" : userData.zipCode;
    document.getElementById("Stadt").value = userData.city === uundefined || null ? "" : userData.city;
    document.getElementById("Straße").value = userData.primaryAddress === undefined || null ? "" : userData.primaryAddress;
    document.getElementById("Zusatz").value = userData.secondaryAddress === undefined || null ? "" : userData.secondaryAddress;
    document.getElementById("anmeldung").hidden = true;
    //document.getElementById("guestLogin").hidden = true;
